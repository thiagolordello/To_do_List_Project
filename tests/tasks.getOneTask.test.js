...
describe('Testes GET da rota /tasks/onetask/idTask', function(done){
    let token;
  
    const reqOneTaskById = async(tkn) =>  {
      const response = await (requester.get('/tasks/onetask/2').set(tkn));
      return response;
      ...
      it('Retorna o status 200,quando a requisicao get for bem sucedida e valida o retorno da task requisitada!', async function () {
